...
class MLP(nn.Module):
    def __init__(self, input_size, num_hidden_layers, output_size, dropout=0.2760938508664678):
...
class DeconvolutionModel:
    def __init__(self, input_size, num_hidden_layers, output_size, device=None):
        ...
        self.optimizer = optim.Adam(self.model.parameters(), lr=1.0873854540189868e-05, weight_decay=0.04806155911017752)
        self.train_losses = []
        self.val_losses = []

...
class MLP(nn.Module):
    def __init__(self, input_size, activation, num_hidden_layers, output_size, dropout=0):
...
class SNV2LinFreqs(DeconvolutionModel):
    ...
    def _objective(self, trial, config):
        ...
        activation = trial.suggest_categorical('activation', ['ReLU', 'LeakyReLU', 'ELU', 'Tanh', 'Sigmoid'])
    ...
    def optimize(self, n_trials=100, config={}, warmup_steps=10, pruner=True):
        ...
        self.study_name = "snv2linfreqs_tuning_sparsemax"  # Unique identifier of the study.

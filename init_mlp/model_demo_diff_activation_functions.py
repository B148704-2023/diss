...
from model_diff_act_funcs import DeconvolutionModel
...
def main():
    ...
    activation_functions=['ReLU', 'Tanh', 'Sigmoid', 'ELU', 'LeakyReLU', 'PReLU']
    for activation in activation_functions:
        model = DeconvolutionModel(input_size, output_size, num_hidden_layers, activation, device)
